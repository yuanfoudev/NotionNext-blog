const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2023-05-23', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '🎉欢迎来到我的博客', url: 'https://happyfou.com/about' },
  ],
  ...
  HEO_HERO_CATEGORY_2: { title: '精读文', url: '/category/精读' },
  HEO_HERO_CATEGORY_3: { title: '乐思考', url: '/category/思考' },
  ...
  HEO_INFO_CARD_URL: 'https://github.com/yuanfoudev', // 个人资料底部按钮链接
